...
This is the only optional external keyword-data call. **Only pull DataForSEO keyword volumes when the analysis suggests the user should consider pivoting their title/positioning to a different but related term.** For example:
